...
import 'package:hunt/ui/common/apifunctions/requestLoginAPI.dart';
import 'package:hunt/ui/common/functions/showDialogSingleButton.dart';
import 'package:hunt/ui/common/platform/platformScaffold.dart';
import 'package:hunt/ui/common/widgets/basicDrawer.dart';
...
class LoginScreenState extends State<LoginScreen> {
  ...
  String _welcomeString = "Something";
                ...
                Padding(padding: EdgeInsets.fromLTRB(0.0, 5.0, 0.0, 78.0),
                  child: RichText(
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: 'This is the logon screen. If you would like to search for something about Flutter you can go to ',
